...
// ANSWER: No. This solution already has a runtime of O(1) because the for-loop will only run a maximum of four times.
...
// ANSWER: 
const getNumbersSquared = (numbers) => {
  for (let i = 0; i < numbers.length; i++) {
...
// ANSWER: each function has an object with each letter and a string